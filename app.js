...
requset.onload = function () {
    ...
    document.querySelector("#temp").innerHTML =
        Math.trunc(obj.main.temp - 273.15) + "°";
    ...
    sunries_time.innerHTML = raisedate.toLocaleString('en');
    sunset_time.innerHTML = setdate.toLocaleString('en');
    ...
    if (weather_status == "few clouds") {
        status_image.src = "./images/few.png";
    }
};
